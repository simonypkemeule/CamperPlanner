        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Voornaam = table.Column<string>(type: "varchar(50)", nullable: true),
                    Achternaam = table.Column<string>(type: "varchar(50)", nullable: true),
                    Bankrekening = table.Column<string>(type: "varchar(50)", nullable: true),
                    Postcode = table.Column<string>(type: "varchar(50)", nullable: true),
                    Straatnaam = table.Column<string>(type: "varchar(50)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EindDatum = table.Column<string>(type: "varchar(50)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VoertuigId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VoertuigenVoertuigID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contracten", x => x.ContractId);
                    table.ForeignKey(
                        name: "FK_Contracten_Voertuigen_VoertuigenVoertuigID",
                        column: x => x.VoertuigenVoertuigID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracten_VoertuigenVoertuigID",
                table: "Contracten",
                column: "VoertuigenVoertuigID");
